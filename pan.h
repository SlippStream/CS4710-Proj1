...
#define _nstates1	21	/* p1 */
#define minseq1	62
#define maxseq1	81
#define _endstate1	20

#define _nstates0	63	/* main */
#define minseq0	0
#define maxseq0	61
...
#define Pmain	((P0 *)_this)
typedef struct P0 { /* main */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, tmp) - 1*sizeof(uchar))
